...
module RPM_Tags
  ...
  module RPM_Tags::Signature
      ...
      PAYLOADSIZE = 1007
      RESERVEDSPACE = 1008
      BADSHA1_1 = RPMTAG_BADSHA1_1
      BADSHA1_2 = RPMTAG_BADSHA1_2
      DSA = RPMTAG_DSAHEADER
      RSA = RPMTAG_RSAHEADER
      SHA1 = RPMTAG_SHA1HEADER
      LONGSIZE = RPMTAG_LONGSIGSIZE
      LONGARCHIVESIZE = RPMTAG_LONGARCHIVESIZE
      SHA256 = RPMTAG_SHA256HEADER
      FILESIGNATURES = RPMTAG_SIG_BASE + 18
      FILESIGNATURELENGTH = RPMTAG_SIG_BASE + 19
      VERITYSIGNATURES = RPMTAG_VERITYSIGNATURES
      VERITYSIGNATUREALGO = RPMTAG_VERITYSIGNATUREALGO
  end
end
