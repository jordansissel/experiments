...
module RPM_Tags
  ...
  module RPM_Tags::Signature
      HEADERSIGNATURES = ::RPM_Tags::HEADERSIGNATURES
      SIZE = 1000
      LEMD5_1 = 1001
      PGP = 1002
      LEMD5_2 = 1003
      ...
      PAYLOADSIZE = 1007
      RESERVEDSPACE = 1008
      BADSHA1_1 = RPM_Tags::BADSHA1_1
      BADSHA1_2 = RPM_Tags::BADSHA1_2
      DSA = RPM_Tags::DSAHEADER
      RSA = RPM_Tags::RSAHEADER
      SHA1 = RPM_Tags::SHA1HEADER
      LONGSIZE = RPM_Tags::LONGSIGSIZE
      LONGARCHIVESIZE = RPM_Tags::LONGARCHIVESIZE
      SHA256 = RPM_Tags::SHA256HEADER
      FILESIGNATURES = RPM_Tags::SIG_BASE + 18
      FILESIGNATURELENGTH = RPM_Tags::SIG_BASE + 19
      VERITYSIGNATURES = RPM_Tags::VERITYSIGNATURES
      VERITYSIGNATUREALGO = RPM_Tags::VERITYSIGNATUREALGO
  end
end
